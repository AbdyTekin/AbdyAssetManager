...
namespace AbdyManagement
{
    public class AssetDatabaseEditor : EditorWindow
    {
        ...
        private const string s_editorName = "Asset Database Editor";
        private const string s_menuPath = "Tools/Abdy/Asset Database";
        ...
        private const string s_uxmlFileLocation = "Assets/Abdy Asset Database/UI Toolkit/UI Document/AssetDatabaseEditorWindow.uxml";
        ...
        {
            var wnd = GetWindow<AssetDatabaseEditor>();
